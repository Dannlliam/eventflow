...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // GraphQL endpoints - allow for development (in production, should be authenticated)
                .requestMatchers("/graphql/**").permitAll()
                
                // Kafka metrics endpoints - allow for development
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(List.of("*")); // Allow all headers including custom ones
